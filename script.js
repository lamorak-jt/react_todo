...
var ToDoList = function (_React$Component2) {
  ...
  _createClass(ToDoList, [{
    ...
    value: function toggleComplete(id, completed) {
      ...
      fetch("https://fewd-todolist-api.onrender.com/tasks/" + id + "/mark_" + newState + "?api_key=272", {
        method: "PUT",
        mode: "cors"
    ...
    value: function fetchTasks() {
      ...
      fetch("https://fewd-todolist-api.onrender.com/tasks?api_key=272").then(checkStatus).then(json).then(function (response) {
    ...
    value: function deleteTask(id) {
      ...
      fetch("https://fewd-todolist-api.onrender.com/tasks/" + id + "?api_key=272", {
        method: "DELETE",
        mode: "cors"
      }).then(checkStatus).then(json).then(function (data) {
    ...
    value: function handleSubmit(event) {
      ...
      fetch("https://fewd-todolist-api.onrender.com/tasks?api_key=272", {
        method: "POST",
        mode: "cors",
